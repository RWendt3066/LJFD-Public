<html lang="en">
  <head>
    ...
    // ====================================================================== //
      ...
      $emailTitle = '<h2>Request for Public Relations Event</h2>';

      // eMail Permitee Information
      $contact = '<div>';
      $contact .= '<p><b>CONTACT INFORMATION:</b></p>';
      $contact .= '<b>Contact: </b>'.$firstname.' '.$lastname.'<br />';
      $contact .= '<b>Phone: </b>'.$full_phone.'<br />';
      $contact .= '<b>Email: </b>'.$email.'<br />';
      $contact .= '<br />';
      $contact .= '</div>';

      // eMail Event Description Information
      $description = '<p><b>DESCRIPTION OF EVENT:</b></p>';
      $description .= '<b>Type of Event: </b>'.$event.'<br />';
      $description .= '<b>Requested Date: </b>'.$event_date.'<br />';
      $description .= '<b>Requested Time: </b>'.$event_time.'<br />';
      $description .= '<br />';
      $description .= '</div>';
      ...
      if ($location == 'Community')
      {
        ...
        $description .= (strlen($address2) >= 1 ? $address1.'<br />'.$address2 : $address1).'<br />';
        $description .= $city.', '.$state.' '.$zip.'<br />';
      };
      if ($location == 'Station')
      {
        $description .= '<b>Location: </b>'.$station.'<br />';
      };
        $description .= '<br />';

      if (strlen($sc_info) >= 1)
      {
        $description .= '<p><b>ADDITIONAL COMMENTS:</b></p>';
      ...
      echo      'var toAddress = "rwendtpmp@gmail.com, msather@ljfd.org";';
      //        echo      'var toAddress = "rwendtpmp@gmail.com";';
      echo      'var fromAddress = "'.$email.'";';
      echo      'var subject = "eRequest for PR Event";';
      echo      'var mailContent = "'.$emailTitle.$contact.$description.'";';
